...
REM
REM Generated by Vivado on Sat May 16 00:31:41 +0700 2026
...
echo "xvlog --incr --relax -prj tb_linear_layer_vlog.prj"
call xvlog  --incr --relax -prj tb_linear_layer_vlog.prj -log xvlog.log
